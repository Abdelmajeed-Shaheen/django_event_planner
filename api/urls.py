...
from .views import EventView, Register , BookingView ,ListofOrganizersView
...
urlpatterns = [
	...
	path('api/follow/list', ListofOrganizersView.as_view(), name='api-event-booking'),
	path('api/Follow/<int:organizer_id>', ListofOrganizersView.as_view(), name='api-event-booking'),
	path('api/Follow/delete/<int:organizer_id>', ListofOrganizersView.as_view(), name='api-event-booking'),
